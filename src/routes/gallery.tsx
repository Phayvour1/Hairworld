...
export const Route = createFileRoute("/gallery")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Explore past editions, press kits, and frequently asked questions." },
      { property: "og:title", content: "Gallery — World Hair Expo" },
      ...
      <section className="py-24 md:py-32 px-6 lg:px-12 max-w-[1600px] mx-auto">
        <div className="grid grid-cols-2 md:grid-cols-12 gap-4 md:gap-8">
          <div className="md:col-span-8 overflow-hidden group">
            <img src={gallery1} alt="" className="w-full h-full object-cover aspect-video group-hover:scale-105 transition-transform duration-[1.5s]" />
          </div>
          <div className="md:col-span-4 overflow-hidden group">
            <img src={gallery2} alt="" className="w-full h-full object-cover aspect-[4/5] group-hover:scale-105 transition-transform duration-[1.5s]" />
          </div>
          <div className="md:col-span-4 overflow-hidden group">
            <img src={editorial1} alt="" className="w-full h-full object-cover aspect-square group-hover:scale-105 transition-transform duration-[1.5s]" />
          </div>
          <div className="md:col-span-8 overflow-hidden group">
            <img src={gallery3} alt="" className="w-full h-full object-cover aspect-video group-hover:scale-105 transition-transform duration-[1.5s]" />
          </div>
          <div className="md:col-span-6 overflow-hidden group">
            <img src={editorial2} alt="" className="w-full h-full object-cover aspect-video group-hover:scale-105 transition-transform duration-[1.5s]" />
          </div>
          <div className="md:col-span-6 overflow-hidden group">
            <img src={editorial3} alt="" className="w-full h-full object-cover aspect-video group-hover:scale-105 transition-transform duration-[1.5s]" />
          </div>
        </div>
      </section>
      ...
      <section className="py-24 md:py-32 px-6 lg:px-12 bg-secondary/30">
        <div className="max-w-[1600px] mx-auto grid md:grid-cols-2 gap-20 items-center">
          <div>
            ...
            <h2 className="font-display text-5xl md:text-7xl tracking-tight leading-[0.95] mb-8">
              The <span className="font-serif-italic text-primary">Press</span> Kit.
            </h2>
