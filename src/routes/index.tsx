...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      { title: "World Hair Expo — The Global Hair, Beauty & Lifestyle Exhibition" },
      { name: "description", content: "The world's premier hair, beauty and lifestyle exhibition. Cinematic runways, master classes and the brands defining global beauty." },
      { property: "og:title", content: "World Hair Expo" },
      { property: "og:description", content: "The world's premier hair, beauty and lifestyle exhibition." },
  ...
  return (
    <>
      ...
      <section className="relative h-[100svh] min-h-[680px] w-full overflow-hidden">
        ...
        <div className="relative z-10 h-full flex flex-col justify-between text-background px-6 lg:px-12 pt-32 pb-12 max-w-[1600px] mx-auto">
          ...
          <div className="animate-reveal">
            ...
            <div className="mt-8 flex flex-col md:flex-row md:items-end md:justify-between gap-8">
              <p className="max-w-md text-sm md:text-base text-background/80 leading-relaxed">
                Five days. One stage. The most influential gathering of hair, beauty and lifestyle brands on the planet.
              </p>
              <div className="flex flex-col sm:flex-row gap-3">
                <Link
                  to="/exhibition"
                  className="px-8 py-4 bg-background text-foreground font-mono text-[11px] uppercase tracking-[0.25em] hover:bg-primary hover:text-primary-foreground transition-all"
                >
                  Buy Tickets
                </Link>
                <Link
                  to="/experience"
                  className="px-8 py-4 border border-background/40 font-mono text-[11px] uppercase tracking-[0.25em] hover:bg-background hover:text-foreground transition-all"
                >
                  The Experience
                </Link>
              </div>
        ...
        <div className="absolute bottom-8 right-8 z-10 hidden md:flex items-center gap-3 font-mono text-[10px] uppercase tracking-[0.3em] text-background/70">
        ...
        <div className="grid md:grid-cols-12 gap-12 md:gap-20 items-start">
          ...
          <div className="md:col-span-7">
            <img
              ...
              width={1024}
              height={1280}
              className="w-full aspect-[4/5] object-cover mb-10 animate-clip"
            />
      ...
      <section className="bg-foreground text-background py-32 md:py-44 px-6 lg:px-12">
        <div className="max-w-[1600px] mx-auto">
          ...
          <div className="mt-16 text-center">
            <Link to="/exhibition" hash="sponsors" className="font-mono text-[10px] uppercase tracking-[0.3em] border-b border-background/40 pb-1 hover:text-primary hover:border-primary transition-all">
              View all tiers →
            </Link>
          </div>
        </div>
      ...
      <section className="py-32 md:py-44 bg-background">
        <div className="max-w-[1600px] mx-auto px-6 lg:px-12">
          <div className="flex justify-between items-end mb-16">
            ...
            <Link to="/gallery" className="hidden md:inline font-mono text-[10px] uppercase tracking-[0.3em] hover:text-primary transition-colors">
              Full Archive →
            </Link>
          </div>
            ...
            {[gallery1, gallery2, gallery3, gallery4].map((src, i) => (
              <div key={i} className="overflow-hidden">
                <img
                  ...
                  width={800}
                  height={1000}
                  className="aspect-[4/5] w-full object-cover hover:scale-105 transition-transform duration-[1200ms] ease-out"
                />
              </div>
            ))}
          </div>
