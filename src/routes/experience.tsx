...
export const Route = createFileRoute("/experience")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "The vision, program pillars, and editorial imagery of the world's most influential hair exhibition." },
      { property: "og:title", content: "The Experience — World Hair Expo" },
    ...
    <>
        ...
        <div className="grid md:grid-cols-12 gap-12 md:gap-20">
          <div className="md:col-span-5">
            ...
            <h2 className="font-display text-4xl md:text-6xl leading-[1.05] tracking-tight">
              Four worlds, <span className="font-serif-italic text-primary">one</span> cinematic stage.
            </h2>
          </div>
            ...
            {[
              ...
              <div key={p.n} className="group">
                <div className="flex items-start gap-8 mb-8">
                  ...
                  <div>
                    <h3 className="font-display text-3xl md:text-5xl mb-6 tracking-tight">{p.t}</h3>
                    <p className="text-muted-foreground leading-relaxed max-w-xl">{p.d}</p>
                  </div>
                </div>
                <div className="overflow-hidden aspect-[16/9] bg-secondary">
                  <img src={p.img} alt={p.t} className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-[1.5s] ease-out-expo" />
                </div>
              </div>
            ))}
          </div>
      ...
      <section className="py-24 md:py-32 px-6 lg:px-12 bg-foreground text-background">
        <div className="max-w-[1600px] mx-auto text-center">
          ...
          <h2 className="font-display text-5xl md:text-[8vw] leading-[0.9] tracking-tight max-w-6xl mx-auto mb-16">
            Where the industry comes to be <span className="font-serif-italic text-primary">seen</span>.
          </h2>
