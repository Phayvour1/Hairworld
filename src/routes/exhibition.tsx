...
export const Route = createFileRoute("/exhibition")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Schedule, exhibitor applications, and sponsor tiers for the World Hair Expo." },
      { property: "og:title", content: "Exhibition — World Hair Expo" },
      { property: "og:image", content: editorial2 },
    ],
  }),
    ...
    <>
          ...
          {days.map((d) => (
            <div key={d.day} className="bg-background grid md:grid-cols-12 gap-8 p-8 md:p-12 hover:bg-secondary transition-colors group">
              ...
              <div className="md:col-span-4">
                <h3 className="font-display text-3xl md:text-4xl tracking-tight group-hover:text-primary transition-colors">
                  {d.t}
                </h3>
              </div>
      ...
      <section id="sponsors" className="py-24 md:py-44 px-6 lg:px-12 bg-foreground text-background">
        <div className="max-w-[1600px] mx-auto">
          ...
          <h2 className="font-display text-5xl md:text-7xl mb-20 max-w-3xl leading-[1] tracking-tight">
            Join the company of <span className="font-serif-italic text-primary">icons</span>.
          </h2>
          <div className="grid md:grid-cols-3 gap-px bg-background/10 border border-background/10">
            {sponsors.map((s) => (
              <div key={s.tier} className="bg-foreground p-10 md:p-12 flex flex-col justify-between min-h-[400px]">
                <div>
                  <h3 className="font-display text-4xl md:text-5xl mb-4 tracking-tight">{s.tier}</h3>
        ...
        <div className="grid md:grid-cols-2 gap-20">
          <div>
            ...
            <h2 className="font-display text-5xl md:text-7xl leading-[0.95] tracking-tight mb-8">
              Showcase your <span className="font-serif-italic text-primary">craft</span>.
            </h2>
